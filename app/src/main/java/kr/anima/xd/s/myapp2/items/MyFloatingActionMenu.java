...
public class MyFloatingActionMenu extends FloatingActionsMenu {
    ...
    public MyFloatingActionMenu(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonSize = attr.getInt(com.getbase.floatingactionbutton.R.styleable.FloatingActionsMenu_fab_addButtonSize, FloatingActionButton.SIZE_MINI);
        mAddButtonStrokeVisible = attr.getBoolean(com.getbase.floatingactionbutton.R.styleable.FloatingActionsMenu_fab_addButtonStrokeVisible, false);
        mExpandDirection = attr.getInt(com.getbase.floatingactionbutton.R.styleable.FloatingActionsMenu_fab_expandDirection, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(com.getbase.floatingactionbutton.R.styleable.FloatingActionsMenu_fab_labelStyle, 0);
        mLabelsPosition = attr.getInt(com.getbase.floatingactionbutton.R.styleable.FloatingActionsMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
        attr.recycle();
